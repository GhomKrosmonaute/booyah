...
class MockChip extends chip.ChipBase<MockChipEvents> {
  constructor() {
    super()
...
describe("Hot reloading", () => {
  ...
  test("works with Sequence", () => {
    ...
    parentV2.activate(makeFrameInfo(), makeChipContext(), makeSignal(), memento)
    ...
    parentV3.activate(makeFrameInfo(), makeChipContext(), makeSignal(), memento)
